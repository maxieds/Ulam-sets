...
def compute_ulam_set(n, init_vectors=[(1, 0), (0, 1)], norm=infinity_norm, return_indices = False):
    ...
    for nidx in range(n):
        ...
        pairwise_sums = (pairwise_sums | deepcopy(ulam_set)) - deepcopy(ulam_set)
        ...
        old_ulam_set = deepcopy(ulam_set)
        ulam_set = deepcopy(old_ulam_set | new_ulam)
    if return_indices: 
